...
from qai_hub_models.models._shared.deepseekr1.demo import deepseekr1_chat_demo
...
from qai_hub_models.models.deepseekr1_quantized import MODEL_ID, Model
from qai_hub_models.models.deepseekr1_quantized.model import (
    HF_REPO_NAME,
    HF_REPO_URL,
)
...
# 从huggingface下载模型需要一定时间，等下载完成我再继续。
def deepseekr1_quantized_chat_demo(
...
if __name__ == "__main__":
    deepseekr1_quantized_chat_demo(model_cls=Model)
